...
public class Suggestion {
    ...
    public boolean isGiliranPembeli() { 
        return giliranPembeli; 
    }
    public StatusNego getStatus() { 
        return status; 
    }

    public void setHargaUsulan(int harga) { 
        this.hargaUsulan = harga; 
    }
    public void setStatus(StatusNego status) { 
        this.status = status; 
    }
    public void setGiliranPembeli(boolean val) { 
        this.giliranPembeli = val; 
    }
